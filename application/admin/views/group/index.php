	              ...
	              <div class="toolbar-list" id="toolbar">
	                  <ul>
	                      <li class="button" id="toolbar-popup-new">
	                          <a class="modal" href="#"><span class="icon-32-new"></span>New</a>
	                      </li>
	                      <li class="button" id="toolbar-edit">
	                          <a href="#"><span class="icon-32-edit"></span>Edit</a>
	                      </li>
	                      <li class="button" id="toolbar-copy">
	                          <a href="#"><span class="icon-32-copy"></span>Duplicate</a>
	                      </li>
	                      <li class="divider"></li>
	                      <li class="button" id="toolbar-publish">
	                          <a href="#"><span class="icon-32-publish"></span>Publish</a>
	                      </li>
	                      <li class="button" id="toolbar-unpublish">
	                          <a href="#"><span class="icon-32-unpublish"></span>Unpublish</a>
	                      </li>
	                      <li class="divider"></li>
	                      <li class="button" id="toolbar-checkin">
	                          <a href="#"><span class="icon-32-checkin"></span>Check In</a>
	                      </li>
	                      <li class="button" id="toolbar-trash">
	                          <a href="#"><span class="icon-32-trash"></span>Trash</a>
	                      </li>
	                      <li class="divider"></li>
	                  </ul>
	                  <div class="clr"></div>
